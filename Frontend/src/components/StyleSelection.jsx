...
export default function StyleSelection({
  ...
  const styleOptions = [
    ...
    { label: "Contemporary", image: "/images/contemporary.jpeg" },
    { label: "Minimalist", image: "/images/Minimalistic.png" },
    { label: "Bohemian", image: "/images/bohemian.jpeg" },
    { label: "Traditional", image: "/images/traditional.jpg" },
    { label: "Rustic", image: "/images/rustic.jpeg" },
    { label: "Coastal", image: "/images/coastal.jpg" },
    { label: "Art Deco", image: "/images/artdeco.jpg" },
    ...
    >
      <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "48px" }}>
          ...
          >
            Select the design aesthetic that speaks to you
          </p>
        </div>
        ...
        >
          {styleOptions.map((option, index) => {
            ...
            const isHovered = hoveredStyle === index;
        ...
        >
          <button
            ...
            style={{
              ...
              fontSize: "16px",
              fontWeight: "600",
              color: selectedStyle ? "#FFFDF7" : "rgba(255, 253, 247, 0.5)",
